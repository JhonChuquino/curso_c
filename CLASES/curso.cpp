...
public:
    ...
    string toString2()
    {
        string resumen = "Curso: " + descripcion + " --> Credito:  " + to_string(credito) + " \n ------> nota 1 = " + to_string(nota1) + " ---> nota 2 = " + to_string(nota2) + " ----->nota 3 = " + to_string(nota3);
        //return resumen2;;
        return resumen;
    }
    /*string getResultado(){
        string resumen2 = "nota 1: " + to_string(nota1) + "nota 2: " + to_string(nota2) + "nota 3: " + to_string(nota3);
        return resumen2;
    }*/
};
