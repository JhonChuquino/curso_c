...
# Supongamos que deseas hacer una predicción
fecha_prediccion = '2023-09-29'
tmaxima_prediccion = 32
tminima_prediccion = 19

# Crea un DataFrame con los datos de predicción
data_prediccion = pd.DataFrame({
    'Tmaxima': [tmaxima_prediccion],
    'Tminima': [tminima_prediccion]
})

# Escala los datos de predicción
X_final = scaler.transform(data_prediccion.values)

# Realizar la predicción final para Tmaxima y Tminima
prediccion_final_Tmaxima = model_Tmaxima.predict(X_final)
prediccion_final_Tminima = model_Tminima.predict(X_final)

print(f'Predicción final para Tmaxima: {prediccion_final_Tmaxima[0][0]}')
print(f'Predicción final para Tminima: {prediccion_final_Tminima[0][0]}')